...
class MonthlyFeeController extends Controller
{
    public function index()
    {
        ...
        return view('backend.student.monthly_fee.view', compact('data'));
    }

    public function getMonthlyFeeClassWise(Request $request)
    {
    ...
    public function paySlip(Request $request)
    {
        ...
        $pdf = PDF::loadView('backend.student.monthly_fee.monthly_fee_pdf', compact('data'));
