...
<br> <br>
<strong>Result of : </strong> {{ $data['allData'][0]->examType->name }}
<br> <br>
<table id="customers">
    <tr>
        <td width="50%"> <h4>Year / Session : </h4> {{ $data['allData'][0]->year->name }} </td>
        <td width="50%"> <h4> Class :  </h4>{{ $data['allData'][0]->studentClass->name }} </td>
    </tr>
</table>
<br> <br>
