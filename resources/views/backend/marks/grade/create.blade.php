                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="grade_point" class="form-control" value="{{ old('grade_point') }}">
                                                        @error('grade_point')
                                                        <div class="form-control-feedback text-danger">{{ $message }}</small></div>
                                                        @enderror
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="start_marks" class="form-control" value="{{ old('start_marks') }}">
                                                        @error('start_marks')
                                                        <div class="form-control-feedback text-danger">{{ $message }}</small></div>
                                                        @enderror
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="end_marks" class="form-control" value="{{ old('end_marks') }}">
                                                        @error('end_marks')
                                                        <div class="form-control-feedback text-danger">{{ $message }}</small></div>
                                                        @enderror
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="start_point" class="form-control" value="{{ old('start_point') }}">
                                                        @error('start_point')
                                                        <div class="form-control-feedback text-danger">{{ $message }}</small></div>
                                                        @enderror
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="end_point" class="form-control" value="{{ old('end_point') }}">
                                                        @error('end_point')
                                                        <div class="form-control-feedback text-danger">{{ $message }}</small></div>
                                                        @enderror
                                                    </div>
